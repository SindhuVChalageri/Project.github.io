...
//   if (categoryListingArray.length !== 0 && colorListingArray.length !== 0 && finishListingArray.length!==0 && categoryListingArray.length!==0) {
//       for(let i=0;i<categoryListingArray.length;i++){
//           for(let j=0;j<colorListingArray.length;j++){
//               for(let l=0;l<finishListingArray.length;l++){
//                  for(let k=0;k<categoryListingArray.length;k++){
                  
//               if((categoryListingArray[i]==colorListingArray[j])&&(colorListingArray[j]==finishListingArray[l])&&(finishListingArray[l]==categoryListingArray[k])){
//                   for(let m=0;m<mainArray.length;m++){
//                       if(mainArray[m]===categoryListingArray[i]){
//                           temp++;
//                       }
//                   }
//                   if(temp===0){
...
//       }
//   }
//   else if (categoryListingArray.length !== 0 && colorListingArray.length !== 0) {
//       for(let i=0;i<categoryListingArray.length;i++){
//           for(let j=0;j<colorListingArray.length;j++){
